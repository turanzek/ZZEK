class ZCL_ZINT_OFFLINE_APP_DPC definition
  public
...
protected section.
  ...
  methods APPLICATIONSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZINT_OFFLINE_APP_MPC=>TS_APPLICATION
    raising
  ...
  methods APPLICATIONSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZINT_OFFLINE_APP_MPC=>TT_APPLICATION
  ...
  methods OPERATIONSET_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZINT_OFFLINE_APP_MPC=>TS_OPERATION
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods OPERATIONSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZINT_OFFLINE_APP_MPC=>TT_OPERATION
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
...
CLASS ZCL_ZINT_OFFLINE_APP_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 14.06.2022 07:59:13 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZINT_OFFLINE_APP_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA operationset_create_entity TYPE zcl_zint_offline_app_mpc=>ts_operation.
 DATA applicationset_create_entity TYPE zcl_zint_offline_app_mpc=>ts_application.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA operationset_get_entity TYPE zcl_zint_offline_app_mpc=>ts_operation.
 DATA applicationset_get_entity TYPE zcl_zint_offline_app_mpc=>ts_application.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZINT_OFFLINE_APP_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA operationset_get_entityset TYPE zcl_zint_offline_app_mpc=>tt_operation.
 DATA applicationset_get_entityset TYPE zcl_zint_offline_app_mpc=>tt_application.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA operationset_update_entity TYPE zcl_zint_offline_app_mpc=>ts_operation.
 DATA applicationset_update_entity TYPE zcl_zint_offline_app_mpc=>ts_application.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
