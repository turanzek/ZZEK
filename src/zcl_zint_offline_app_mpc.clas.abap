class ZCL_ZINT_OFFLINE_APP_MPC definition
  public
...
public section.
  ...
  types:
     TS_OPERATION type ZINT_S_OPERATION .
  types:
TT_OPERATION type standard table of TS_OPERATION .
  ...
  types:
     TS_APPLICATION type ZINT_S_OPERATION .
  types:
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZINT_OFFLINE_APP_MPC======CP' ##NO_TEXT.
...
CLASS ZCL_ZINT_OFFLINE_APP_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZINT_OFFLINE_APP_SRV' ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Operationname' iv_abap_fieldname = 'OPERATIONNAME' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Operationdate' iv_abap_fieldname = 'OPERATIONDATE' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZINT_S_OPERATION'
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20220614055912'.                  "#EC NOTEXT
...
ls_text_element-artifact_name          = 'Operationid'.                 "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'Operationname'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Operation'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Operationdate'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Operation'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
