class ZCL_ZZEK_CAR_RESERVATI_MPC definition
  public
...
public section.
  ...
  types:
     TS_RESERVATION type ZZEK_S_REZERVATION .
  types:
TT_RESERVATION type standard table of TS_RESERVATION .
  ...
  types:
     TS_VEHICLE type ZZEK_S_CAR .
  types:
TT_VEHICLE type standard table of TS_VEHICLE .

  constants GC_RESERVATION type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Reservation' ##NO_TEXT.
  constants GC_VEHICLE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Vehicle' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZZEK_CAR_RESERVATI_MPC====CP' ##NO_TEXT.

  methods DEFINE_RESERVATION
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_VEHICLE
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
...
CLASS ZCL_ZZEK_CAR_RESERVATI_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZZEK_CAR_RESERVATION_SRV' ).
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            iv_association_name = 'VehicleToReservation' "#EC NOTEXT
                            iv_left_type        = 'Vehicle' "#EC NOTEXT
                            iv_right_type       = 'Reservation' "#EC NOTEXT
                            iv_right_card       = 'M' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - VehicleToReservation
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'Plate'   iv_dependent_property = 'Plate' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'VehicleToReservationSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'VehicleSet'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'ReservationSet'             "#EC NOTEXT
                                              iv_association_name      = 'VehicleToReservation' ).                                 "#EC NOTEXT
...
* Navigation Properties for entity - Vehicle
lo_entity_type = model->get_entity_type( iv_entity_name = 'Vehicle' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'ToReservation' "#EC NOTEXT
                                                              iv_abap_fieldname = 'TORESERVATION' "#EC NOTEXT
                                                              iv_association_name = 'VehicleToReservation' ). "#EC NOTEXT
  endmethod.
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Marka' iv_abap_fieldname = 'MARKA' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'StartingKm' iv_abap_fieldname = 'STARTINGKM' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'EndingKm' iv_abap_fieldname = 'ENDINGKM' ). "#EC NOTEXT
lo_property->set_type_edm_int16( ).
lo_property->set_creatable( abap_true ).
lo_property->set_updatable( abap_true ).
lo_property->set_sortable( abap_true ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZZEK_S_REZERVATION'
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Vehicle' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Vehicleyear' iv_abap_fieldname = 'VEHICLEYEAR' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Fiyat' iv_abap_fieldname = 'FIYAT' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZZEK_S_CAR'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'VehicleSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20220610135522'.                  "#EC NOTEXT
...
ls_text_element-artifact_name          = 'Plate'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Vehicle'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
ls_text_element-text_symbol            = '033'.              "#EC NOTEXT
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Marka'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Vehicle'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Vehicleyear'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Vehicle'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Reserved'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Vehicle'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Fiyat'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Vehicle'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
